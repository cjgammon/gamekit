 ...
 */
export class WebGPURenderer implements InstanceSink<TextureEntry> {
  ...
  private readonly _quadBuffer: GPUBuffer;
  private readonly _uniformScratch = new Float32Array(MAT3_STD140_FLOATS);
  ...
  private constructor(
    ...
    this.batcher = new SpriteBatcher<TextureEntry>(this);
  }
  ...
  createTextureFromImage(
    ...
    this._device.queue.copyExternalImageToTexture(
      { source: image },
      { texture: gpu, premultipliedAlpha: true },
  ...
  private _entry(gpu: GPUTexture, meta: Texture): TextureEntry {
