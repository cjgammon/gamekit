 ...
 */
export const DEFAULT_UNSUPPORTED_MESSAGE = "This game needs WebGPU. Try Chrome or Edge (any recent version), or Safari 18+.";
 ...
 * ```
 */
export function mountUnsupportedNotice(canvas, message = DEFAULT_UNSUPPORTED_MESSAGE) {
